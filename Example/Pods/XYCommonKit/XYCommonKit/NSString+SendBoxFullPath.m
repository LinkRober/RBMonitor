...
+ (NSString*)xy_getAppPackageString
{
    ...
    NSString * appPackageString = @"/XiaoYing.app";
    if ([bundleID isEqualToString:@"com.quvideo.SlidePlus"]) {
        appPackageString = @"/AutoEdit.app";
    }else if([bundleID isEqualToString:@"com.quvideo.XiaoYingPro"]){
        appPackageString = @"/XiaoYingPro.app";
    }else if([bundleID isEqualToString:@"com.quvideo.KamStar"]){
        appPackageString = @"/KamStar.app";
    }else if([bundleID isEqualToString:@"com.quvideo.wecycle"]){
        appPackageString = @"/WeCycle.app";
    }
